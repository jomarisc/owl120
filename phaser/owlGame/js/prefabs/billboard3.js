...
function Billboard3(game, x, y, dynamicX, dynamicY, key, frame, scale, rotation, targetInterest, endToken)
{
...
Billboard3.prototype = Object.create(Phaser.Sprite.prototype);
Billboard3.prototype.constructor = Billboard2;

Billboard3.prototype.update = function()
{
