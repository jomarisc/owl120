...
LevelThree.prototype = {
	...
	preload: function() {
		...
		game.load.image("interactableBuilding", "assets/img/redbuildings0003.png");
		game.load.image("interactableBuildingL", "assets/img/redbuildings0004.png");
	...
	create: function() {
		...
		var standardX = [1750 + (2400 * 0), 50 + (2400 * 1), 1450 + (2400 * 1), 834 + (2400 * 3), 1090 + (2400 * 3), 1346 + (2400 * 3), 1602 + (2400 * 3), 0 + (2400 * 4), 500 + (2400 * 4), 1500 + (2400 * 4), 2200 + (2400 * 4), 500 + (2400 * 5), 1750 + (2400 * 5), 2500 + (2400 * 5), 850 + (2400 * 6), 1700-150 + (2400 * 6), 2550-300 + (2400 * 6), 1000-150 + (2400 * 7), 2000 + (2400 * 7), 2300 + (2400 * 8), 3000 + (2400 * 8)]; //, 2000 + (2400 * 9)];
		...
		this.endToken = new endToken(game, game.world.width-200, game.world.height-200, "endToken", 0, 1, 0); // game.world.width-200
		game.add.existing(this.endToken);
		
		// Creating Player
		// More slower overall movement for the player in level three
		this.player = new OwlFabs(game, game.world.width * (1 / 100), game.world.height - 200, "jumpSound", "owl", "64sadOwl0000", 2, 1000*(2/4), 300*(2/4), 600*(3/4), 3000*(2/4), 2000*(2/4), 1000*(3/4));
